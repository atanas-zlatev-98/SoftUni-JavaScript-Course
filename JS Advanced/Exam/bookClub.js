class BookClub{
    ...
    assignBookToMember(memberName, bookTitle){
        let findMember = this.members.find(member => member.memberName === memberName);
        let findBook = this.books.find(book=>book.title === bookTitle);
    ...
    generateReadingReport(){
        ...
        let availableBooks = `Available Books in ${this.library} library:\n`;
