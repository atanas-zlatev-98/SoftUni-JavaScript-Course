...
console.log(recipeSelection.getRecipesByCategory([{ title: "Spicy Tofu Stir-Fry", category: "Asian" },{ title: "dogs", category: "Asian" }],'Asian'));
let arr = [ 'Spicy Tofu Stir-Fry', 'dogs' ];
let arr2 = [ 'Spicy Tofu Stir-Fry', 'dogs' ];
